...
export default function FeaturesSection() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'Выгодное расположение обеспечивает легкий доступ как к природным достопримечательностям, так и к городской инфраструктуре.',
      icon: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          <path
    ...
    },
    {
      ...
      description:
        'Мы следим за каждой мелочью — от свежего белья до ароматного чая в номере.',
      icon: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          <path 
            d="M14 4L18 8L14 12" 
