  ...
  const services = [
    {
      ...
      description: "Просторные комфортабельные номера с видом на горы",
      detail: "Каждый номер оснащен двуспальной кроватью из массива дерева, двухъярусной кроватью, умным освещением и тёплыми полами. В распоряжении гостей отдельный санузел с душем, свежее белье и халаты.",
    ...
    },
    {
      ...
      detail: "Полностью оборудованные домики с двуспальной кроватью, диваном, тёплыми полами и всеми удобствами. Вечерние прогулки по освещенным дорожкам подарят незабываемые впечатления.",
      category: "accommodation",
      icon: <Tent size={18} />,
    ...
    },
    {
      ...
      detail: "Комфортная зона отдыха с шезлонгами и лежаками. Бассейн расположен напротив основного здания - идеально для семей с детьми и больших компаний.",
      category: "activities",
      icon: <Waves size={18} />,
    ...
    },
    {
      id: 4,
      title: "Мини-бани",
      description: "В скором времени будет банный комплекс с видом на реку и горы",
    ...
    },
    {
      ...
      description: "Круглосуточная столовая",
      detail: "Гостеприимный персонал всегда готов помочь вам. Столовая в большом доме для мероприятий",
      category: "food",
    ...
    },
    {
      id: 6,
      title: "Горная река",
      description: "Прогулки вдоль горной реки с кристально чистой водой",
      detail: "Наслаждайтесь шумом воды и свежестью горного воздуха. Идеальное место для созерцания природы и фотосессий.",
      category: "activities",
    ...
    },
    {
      ...
      detail: "Тёплые полы, умное освещение и современные системы вентиляции обеспечивают комфортное пребывание в любое время года. Ощутите настоящий домашний уют вдали от дома.",
      category: "wellness",
