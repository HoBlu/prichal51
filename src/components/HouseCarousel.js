...
const houses = [
  {
    ...
    name: "Гостевой дом",
    description: "Этот гостевой дом — идеальное место для тех, кто ценит экологическую чистоту, комфорт и близость к природе.Гостевой дом, выполненный из кедра, представляет собой гармоничное сочетание комфорта и природы. Экологически чистый материал обеспечивает не только эстетическую привлекательность, но и долговечность конструкции. Кедр обладает естественными антисептическими свойствами, что делает его идеальным выбором для создания здоровой атмосферы.",
    area: "20 м²",
    rooms: "Домик с  терассой",
    capacity: "До 4 человек",
    amenities: ["", "Теплый пол в ванной", "Мини-холодильник","Микроволновка","Водонагреватель", "Терраса", "Душевая и санузел", "Wi-Fi"]
  },
  {
    id: 2,
