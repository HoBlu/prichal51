...
const houses = [
  {
    ...
    name: "ГОСТЕВОЙ ДОМ",
    description: "Гостевой дом, выполненный из кедра, представляет собой гармоничное сочетание комфорта и природы. Экологически чистый материал обеспечивает не только эстетическую привлекательность, но и долговечность конструкции. Кедр обладает естественными антисептическими свойствами, что делает его идеальным выбором для создания здоровой атмосферы.",
    area: "20 м²",
    rooms: "Домик с  террасой",
    capacity: "До 4 человек",
    amenities: ["Двуспальная кровать","Двухъярусная кровать", "Теплый пол в ванной", "Мини-холодильник","Микроволновка","Водонагреватель", "Терраса", "Душевая и санузел", "Wi-Fi"]
  },
  {
    id: 2,
    ...
    capacity: "До 4 человек",
    amenities: ["Двуспальная кровать","Диван", "Теплый пол в ванной", "Мини-холодильник","Микроволновка","Водонагреватель", "Терраса", "Душевая и санузел", "Wi-Fi"]
  }
];
