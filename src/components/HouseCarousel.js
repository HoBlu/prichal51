...
const houses = [
  {
    ...
    name: "СЕМЕЙНЫЙ ЛЮКС",
    description: "Наши домики выполнены из натурального кедра – дерева с уникальным ароматом и целебными свойствами, обеспечивающего надежность и теплоизоляцию.",
    area: "20 м²",
