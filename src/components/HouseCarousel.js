...
const houses = [
  {
    ...
    name: "СЕМЕЙНЫЙ ЛЮКС",
    description: "Наши домики выполнены из натурального кедра – дерева с уникальным ароматом и целебными свойствами, обеспечивающего надежность и теплоизоляциюГостевой дом, выполненный из кедра, представляет собой гармоничное сочетание комфорта и природы. Экологически чистый материал обеспечивает не только эстетическую привлекательность, но и долговечность конструкции. Кедр обладает естественными антисептическими свойствами, что делает его идеальным выбором для создания здоровой атмосферы.Архитектура здания подчеркивает природные линии и текстуру дерева, создавая уютное пространство для отдыха. Большие окна наполняют комнаты светом и открывают живописные виды на окружающий ландшафт. Интерьеры оформлены в теплых тонах, с использованием натуральных материалов, что создает атмосферу спокойствия и умиротворения.На территории гостевого дома предусмотрены зоны для отдыха на свежем воздухе, где гости могут наслаждаться ароматом кедрового леса и звуками природы. Также предлагаются различные услуги, такие как сауна, велосипедные прогулки и экскурсии по живописным окрестностям, что делает пребывание незабываемым. Этот гостевой дом — идеальное место для тех, кто ценит экологическую чистоту, комфорт и близость к природе..",
    area: "20 м²",
