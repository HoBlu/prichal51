...
export default function Services() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero секция */}
      <div className="relative h-96 bg-blue-800">
        <div 
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 bg-blue-500 text-white flex items-center justify-center rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                </div>
                <div className="ml-5">
                  <h3 className="text-xl font-semibold text-blue-800 mb-2">НОМЕРА В БОЛЬШОМ ДОМЕ</h3>
              ...
              <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 bg-teal-500 text-white flex items-center justify-center rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Бассейн */}
        <div className="mb-20">
          <div className="bg-gradient-to-r from-blue-400 to-teal-400 text-white p-12 relative overflow-hidden shadow-md rounded-md">
            <div className="relative z-10">
              <h2 className="text-3xl font-bold mb-6">БАССЕЙН</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="flex items-center justify-center">
                  <div className="w-64 h-64 border-8 border-white relative">
                    <div className="absolute inset-0 bg-blue-500 opacity-60"></div>
                    <div className="absolute bottom-0 left-0 w-full h-1/3 bg-teal-500 opacity-40"></div>
                    <div className="absolute top-4 right-4 text-white text-3xl font-bold">16×8</div>
                    <div className="absolute bottom-4 left-4 text-white font-bold">БАССЕЙН</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-bl from-blue-100 to-transparent opacity-50 transform -skew-x-12 translate-x-20"></div>
          </div>
        </div>
        
        {/* Дополнительные услуги */}
        <div className="mb-20">
          <h2 className="text-3xl font-bold mb-6 text-blue-800">ДОПОЛНИТЕЛЬНЫЕ УСЛУГИ</h2>
          <div className="w-16 h-1 bg-teal-500 mb-12"></div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 shadow hover:shadow-lg transition-shadow duration-300 border border-gray-200 rounded-md">
              <div className="w-16 h-16 bg-blue-500 text-white flex items-center justify-center mb-6 rounded-md">
            ...
            <div className="bg-white p-8 shadow hover:shadow-lg transition-shadow duration-300 border border-gray-200 rounded-md">
              <div className="w-16 h-16 bg-teal-500 text-white flex items-center justify-center mb-6 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-4 text-blue-800">МАНГАЛЬНЫЕ ЗОНЫ</h3>
              <p className="text-gray-700 mb-6">
                Специально оборудованные места для барбекю позволят вам насладиться 
                приготовлением еды на открытом огне в кругу близких.
              </p>
            </div>
            ...
            <div className="bg-white p-8 shadow hover:shadow-lg transition-shadow duration-300 border border-gray-200 rounded-md">
              ...
              <h3 className="text-xl font-bold mb-4 text-blue-800">БЛИЗОСТЬ К МАГАЗИНАМ</h3>
              <p className="text-gray-700 mb-6">
                База отдыха расположена недалеко от магазинов, где вы сможете приобрести 
        ...
        <div>
          <h2 className="text-3xl font-bold mb-6 text-blue-800">ОСОБЕННОСТИ ТЕРРИТОРИИ</h2>
          <div className="w-16 h-1 bg-teal-500 mb-12"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div className="bg-white shadow-md rounded-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  База расположена вблизи живописного берега горной реки, что создает особую атмосферу единения 
                  с природой. Шум воды и свежий горный воздух станут приятным дополнением к вашему отдыху.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white shadow-md rounded-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  Вдоль всех домиков проходит удобная дорожка с декоративной подсветкой, что делает 
                  вечерние прогулки по территории не только приятными, но и безопасными.
                </p>
              </div>
            </div>
          </div>
