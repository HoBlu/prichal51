          ...
          {activeTab === 'описание' && (
            ...
            bg-gradient-to-bl from-blue-100 to-transparent">
              <div className="prose max-w-none">
                ...
                Добро пожаловать в наш уютный гостевой дом, расположенный в живописном месте у берега горной реки. Этот современный кедровый дом площадью 20 кв.м идеально подходит для отдыха от городской суеты и погружения в природу.
                </p>
                <p className="text-gray-700 leading-relaxed text-lg">
                    Уютный домик из кедра, спрятанный среди величественных гор, словно теплая пристань у бурлящей реки. 20 квадратов уюта, где аромат дерева смешивается с 
                    прохладой горного воздуха. Внутри — мягкий свет, теплые полы и все, что нужно для 
                    полного расслабления: удобная двуспальная кровать, двухъярусный уголок для гостей, душ с горячей водой, 
                    мини-холодильник для свежих завтраков. А с террасы — вид, от которого замирает сердце: река, вечно бегущая к горизонту, и небо, меняющее краски с 
                    восходом и закатом. Здесь время замедляет шаг, а душа отдыхает.
                </p>
                <p className="text-gray-700 leading-relaxed text-lg">
                  Особого внимания заслуживает просторная терраса, где вы сможете наслаждаться утренним кофе под пение птиц или провести вечер в уютной атмосфере.
                </p>
              </div>
              ...
              <div className="bg-white/90 backdrop-blur-sm p-8 rounded-md border border-blue-400 mt-8 transition-all hover:shadow-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="text-gray-700 text-lg">Площадь: 20 м²</span>
                  </div>
                  <div className="flex items-center space-x-4">
                    <div className="bg-white p-3 rounded-full shadow-sm text-blue-500">
                      <Users size={24} />
