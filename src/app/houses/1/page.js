          ...
          {activeTab === 'описание' && (
            ...
            bg-gradient-to-bl from-blue-100 to-transparent">
              <div className="prose max-w-none">
                ...
                Добро пожаловать в наш уютный домик, расположенный в живописном месте у берега горной реки. Этот современный кедровый домик площадью 20 кв.м идеально подходит для отдыха от городской суеты и погружения в природу.
                </p>
                <p className="text-gray-700 leading-relaxed text-lg">
